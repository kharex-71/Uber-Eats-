...
//NAVIGATORS
export const BOTTOM_TAB_NAV = "BottomTabNavigation";
export const ACCOUNT_NAVIGATOR_SCREEN = "AccountNavigation";
export const DRAWER_NAVIGATOR = "DrawerNavigator";
export const DRAWER_CONTANT = "DrawerContant";
...
export const DEALS_STACK = "DealsStack";

//SETTINGS STACK NAVIGATION
export const SETTINGS_SCREEN = "SettingsScreen";
export const PROMOTION_SCREEN = "PromotionScreen";
